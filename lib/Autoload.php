...
/**
 * Auto loading for Php stuff in JSLab
 * 
...
namespace SchrodtSven\JSLab;

class Autoload
{

    /**
     * Namespace prefix for project files (not reflected by directory structure)
     * @todo 
     * @fixme !!!
     */
    public const VENDOR = 'SchrodtSven\JSLab';


    private const MIMI =  'SchrodtSven\\JSLab';
    /**
     * Lib prefix
     */
